...
#
# Execute this file main.py to play a tournament.
# ps-rock.py implements the round-robin tournament of rock paper scissors
#
# Prior to execution:
...
# Original line 36: Place each module name as an argument to the function
# ps-rock.round_robin().
...
import team1, team2, team3, team4, team5, team9  # These are file names in this folder
