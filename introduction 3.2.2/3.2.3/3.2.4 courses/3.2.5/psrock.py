...
#
# ps-rock.py implements a round-robin tournament of rock-paper-scissors
# To run a tournament, execute ps-rock_play.py, not this file.
# The students and teacher should modify ps-rock_play.py and not modify this file.
#
...
def round_robin(number_of_rounds, *argv):
    ...
    The remaining arguments become a list: argv     is a list of functions, one per player
    """
    ...
    for player1 in argv:
        ...
        for player2 in argv[argv.index(player1) + 1:]:
            ...
            report[player1_name] += "\n" + history1 + " " * 8 + player1_name + ": " + strategy_name(
                player1) + " " + score1 + "\n" + \
                                    history2 + " " * 8 + player2_name + ": " + strategy_name(player2) + "\n"

            report[player2_name] += "\n" + history2 + " " * 8 + player2_name + ": " + strategy_name(
                player2) + " " + score2 + "\n" + \
